...
SECRET_KEY = 'django-insecure-4zfunqui+57i#kux@)bv6noy#wt-r$@yh1wi2m!#qkup2zoq^o'
...
CORS_ALLOW_ALL_ORIGINS = True  # This allows all origins. In production, you'd want to restrict this.
CORS_ALLOW_METHODS = [
    'DELETE',
    'GET',
    'OPTIONS',
